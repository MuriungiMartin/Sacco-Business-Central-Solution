...
Report 50372 "Loans Guard Report"
{
    RDLCLayout = 'Layouts/LoansGuardReport.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Loan  No.") order(ascending) where("Corporate Loan" = filter(false));
            ...
            column(Gender; "Loans Register".Gender)
            {
            }
